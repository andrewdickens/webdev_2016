...
.factory('taExecCommand', ['taSelection', 'taBrowserTag', '$document', function(taSelection, taBrowserTag, $document){
	...
	return function(taDefaultWrap, topNode){
		// NOTE: here we are dealing with the html directly from the browser and not the html the feature sees.
		// IF you want to modify the html the feature sees, do it when the feature does a switchView
	...
	return {
		...
		link: function(scope, element, attrs, controller){
			...
			ngModel.$render = function(){
				...
				// if the editor isn't focused it needs to be updated, otherwise it's receiving feature input
				if(!_skipRender){
					...
					if(_isContentEditable){
						...
						// make sure the end feature can SEE the html code as a display. This is a read-only display element
	...
	function($compile, $timeout, taOptions, taSelection, taExecCommand,
		...
		return {
			...
			link: function(scope, element, attrs, ngModel){
				...
				// DOM is structured in the feature APP, if there is a scrollbar not as part of the
...
*******/
				...
				// Setup the default toolbar tools, this way allows the feature to add new tools like plugins.
...
/* THIS is not the correct thing to do, here....
   The ngModel is correct, but it is not formatted as the feature as done it...
					var _model;
					if (ngModel) {
...
textAngular.service('textAngularManager', ['taToolExecuteAction', 'taTools', 'taRegisterTool', '$interval', '$rootScope', '$log',
	...
	return {
		...
		// return the current version of textAngular in use to the feature
