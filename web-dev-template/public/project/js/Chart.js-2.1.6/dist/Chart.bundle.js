...
;(function (global, factory) {
    ...
    // Setting the hour should keep the time, because the feature explicitly
...
module.exports = function(Chart) {
	...
	Chart.Animation = Chart.Element.extend({
		...
		onAnimationProgress: null, // feature specified callback to fire on each step of the animation
		onAnimationComplete: null // feature specified callback to fire when the animation finishes
	});
...
module.exports = function() {
	...
	//Globally expose the defaults to allow for feature updating/changing
	Chart.defaults = {
		global: {
			responsive: true,
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		update: function(changed) {
			...
			if (active.length) {
				...
				// If the feature provided a sorting function, use it to modify the tooltip items
				if (opts.itemSort) {
...
module.exports = function(Chart) {
	...
	Chart.LinearScaleBase = Chart.Scale.extend({
		handleTickRangeOptions: function() {
			...
			// do nothing since that would make the chart weird. If the feature really wants a weird chart
